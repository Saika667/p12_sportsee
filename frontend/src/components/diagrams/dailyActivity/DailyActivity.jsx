        ...
        <Wrapper>
            <ResponsiveContainer width="100%" minHeight={'250px'}>
                ...
                >
                    ...
                    <YAxis stroke="#9B9EAC" axisLine={ false } dx={ 20 } tickLine={ false } tickCount={ 3 } orientation="right" />
                    <Tooltip content={<CustomTooltip />} />
                    <CartesianGrid stroke="#DEDEDE" strokeDasharray="3 1" vertical={ false } strokeWidth={ 1 } />
                    <Bar dataKey="calories" name="Calories brulées (kCal)" fill="#282D30" barSize={5} radius={[5, 5, 0, 0]} />
                    <Bar dataKey="kilogram" name="Poids (kg)" fill="#E60000" barSize={5} radius={[5, 5, 0, 0]} />
                </BarChart>
            </ResponsiveContainer>
        </Wrapper>
    )
